...
grep -q 'ReviveTLS-M7-WM6-ARMV4I' "${workflow}"
...
for required_source in app/main.cpp app/ui.cpp common/log.cpp mail/imap.cpp mail/smtp.cpp net/socket.cpp net/tls.cpp net/http.cpp; do
